...
function kmr_site_hub_sections(): array {
	...
	return [
		...
		[
			...
			'desc'       => __( 'One room per card: Featured Image + “Choose images…” in Room details for extra carousel slides; excerpt and editor for text only (prices in sidebar).', 'kana-mud-resort' ),
