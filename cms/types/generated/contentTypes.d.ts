...
export interface ApiAmenityAmenity extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    iconKey: Schema.Attribute.String & Schema.Attribute.DefaultTo<'leaf'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::amenity.amenity'
...
export interface ApiBookingBooking extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Primary and secondary booking URLs shown across the site';
    displayName: 'Booking links';
    pluralName: 'bookings';
  ...
  attributes: {
    ...
    footerNote: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Best rates when you book direct.'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::booking.booking'
    ...
    primaryLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Book a stay'>;
    primaryUrl: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'https://example.com/book'>;
    publishedAt: Schema.Attribute.DateTime;
    secondaryLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'WhatsApp concierge'>;
...
export interface ApiHeroHero extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Home hero banner and primary call to action';
    displayName: 'Hero';
    pluralName: 'heroes';
    singularName: 'hero';
  };
  ...
  attributes: {
    backgroundGallery: Schema.Attribute.Media<'images', true>;
    backgroundImage: Schema.Attribute.Media<'images'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ctaLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'View rooms'>;
    ctaTargetSection: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'rooms'>;
    eyebrow: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Welcome'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hero.hero'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    subtitle: Schema.Attribute.Text &
      Schema.Attribute.DefaultTo<'Unwind in thoughtfully designed spaces surrounded by forest and calm.'>;
    title: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'Your sanctuary in nature'>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNearbyPlaceNearbyPlace extends Struct.CollectionTypeSchema {
  collectionName: 'nearby';
  info: {
    description: 'Places near the resort shown below gallery';
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    distanceLabel: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'5 km from property'>;
...
export interface ApiOfferOffer extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Promotions and seasonal deals';
    displayName: 'Offer';
    pluralName: 'offers';
    singularName: 'offer';
  };
  ...
  attributes: {
    badge: Schema.Attribute.String & Schema.Attribute.DefaultTo<'Special'>;
...
export interface ApiPhotoPhoto extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Images shown in the resort gallery section';
...
export interface ApiRoomRoom extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Accommodation types and details';
    displayName: 'Room';
    pluralName: 'rooms';
    singularName: 'room';
  };
  ...
  attributes: {
    ...
    priceLabel: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'From \u20B90 / night'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiSiteSettingSiteSetting extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Editable brand name and header menu links';
  ...
  attributes: {
    brandName: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Kana Mud Resort'>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    publishedAt: Schema.Attribute.DateTime;
    roomSortOrder: Schema.Attribute.Enumeration<
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Guest reviews and quotes';
